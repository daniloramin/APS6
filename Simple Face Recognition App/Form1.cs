...
namespace Simple_Face_Recognition_App
{
    public partial class Form1 : Form
    {
        ...
        CascadeClassifier faceCasacdeClassifier = new CascadeClassifier(@"C:\Users\danil\Desktop\Trabalhos\APS\Simple-Face-Recognition-App-CS\Simple Face Recognition App\haarcascade_frontalface_alt.xml");
        ...
        private void btnCapture_Click(object sender, EventArgs e)
        {
            ...
            //capturarVideo.ImageGrabbed += ProcessFrame;
        ...
        private void ProcessFrame(object sender, EventArgs e)
        {
            ...
            if (capturarVideo != null && capturarVideo.Ptr != IntPtr.Zero)
            {
                ...
                currentFrame = quadro.ToImage<Bgr, Byte>().Resize(picCapture.Width, picCapture.Height, Inter.Cubic);
